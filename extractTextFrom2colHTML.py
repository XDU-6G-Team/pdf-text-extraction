...
from pdfparser.htmlParser import getCSStext, getValueOfClass, getSoup, getClassName, hasAttX, getLongestWS, getBaseValue, printPages
...
def getTextFrom2HTML(htmlFilePath, outputPath, auto="auto"):
    # startTime = datetime.now()
    newPages = []
    # get the css in html
    cssText = getCSStext(htmlFilePath)
    ...
    return cleanParas(paras, outputPath)

def cleanParas(paras, outputPath):
    newParas=[]
